...
public interface SiteMenu {
    String TOOLTIP              = "https://metinvest-intranet-test.azurewebsites.net/ru/admin/tooltips";
    String VACANCY              = "https://metinvest-intranet-test.azurewebsites.net/ru/vacancy";
