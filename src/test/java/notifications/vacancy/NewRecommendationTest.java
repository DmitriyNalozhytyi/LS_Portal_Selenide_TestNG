...
@Epic("Notifications")
public class NewRecommendationTest extends ParentTest {
    ...
    @Feature("Recruiter")
    @Test(description = "Check the notification for a new recommendation to his vacancy")
    ...
    @Feature("Recruiter")
    @Test(description = "Check that recruiter can open recommendation from notification")
    public void checkOpenResponseFromNotification() {
        ...
        new VacancyDetailPage()
                .checkForUserInCard(Data.RECRUITER_3);
    }
