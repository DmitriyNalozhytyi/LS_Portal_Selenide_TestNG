...
public class ArticlesPageAll extends ParentPage {
    ...
    public void selectRandomArticle(){
        ...
        webDriver.findElement(By.cssSelector("div:nth-of-type(" + actions.randomNumber(1, 6) + ") > div > mat-card:nth-of-type(" + actions.randomNumber(1, 4) + ") > app-item .item-block__header.news_top_cont_hed.ng-star-inserted > .default_link")).click();
